            ...
            if flag:
                if "----" not in line and line.strip() != '':
                    ...
                    if 'ind_retweet_no_match' in line.lower():
                        ...
                        if not copied_no_match:
                            shutil.copytree(
                                "C:\\Users\\Andrea\\Documents\\University\\Magistrale\\Tesi\\Bot\\Patterns_test\\dataset\\" + f.name[
                                                                                                                              :len(
                                                                                                                                  f.name) - 4],
                                "C:\\Users\\Andrea\\Documents\\University\\Magistrale\\Tesi\\Bot\\Patterns_test\\re-check\\no_match\\" + f.name[
                                                                                                                                         :len(
                                                                                                                                             f.name) - 4])
                            shutil.copy(str(f),
                                        "C:\\Users\\Andrea\\Documents\\University\\Magistrale\\Tesi\\Bot"
                                        "\\Patterns_test\\re-check\\no_match\\" + f.name[
                                                                                  :len(
                                                                                      f.name) - 4])
                            copied_no_match = True
                        ...
                        if not copied_false:
                            shutil.copytree(
                                "C:\\Users\\Andrea\\Documents\\University\\Magistrale\\Tesi\\Bot\\Patterns_test\\dataset\\" + f.name[
                                                                                                                              :len(
                                                                                                                                  f.name) - 4],
                                "C:\\Users\\Andrea\\Documents\\University\\Magistrale\\Tesi\\Bot\\Patterns_test\\re-check\\false\\" + f.name[
                                                                                                                                      :len(
                                                                                                                                          f.name) - 4])
                            shutil.copy(str(f),
                                        "C:\\Users\\Andrea\\Documents\\University\\Magistrale\\Tesi\\Bot\\Patterns_test\\re-check\\false\\" + f.name[
                            ...
                            shutil.copytree(
                                ...
                                "C:\\Users\\Andrea\\Documents\\University\\Magistrale\\Tesi\\Bot\\Patterns_test\\re-check\\no_match\\" + f.name[
                                                                                                                                         :len(
                                                                                                                                             f.name) - 4])
                            shutil.copy(str(f),
                                        "C:\\Users\\Andrea\\Documents\\University\\Magistrale\\Tesi\\Bot\\Patterns_test\\re-check\\whitelist_like\\no_match\\" + f.name[
                                                                                                                                                                 :len(
                                                                                                                                                                     f.name) - 4])
                            copied_no_match = True
